...
chrome_path = 'C:/Users/SYED/Downloads/chromedriver_win32/chromedriver.exe'
webdriver = webdriver.Chrome(executable_path=chrome_path)
sleep(2)
...
hashtag_list = ['blockchain', 'travel']
prev_user_list = []
                ...
                if webdriver.find_element_by_xpath('/html/body/div[3]/div/div[2]/div/article/header/div[2]/div[1]/div[2]/button').text == 'Follow':
                    ...
                    if comm_prob > 7:
                        ...
                        if (comm_prob < 7):
                            ...
                            comment_box.send_keys('Nice and cute one)')
                            sleep(1)
                        elif comm_prob == 9:
                            comment_box.send_keys('Wow Awesome!!')
                            sleep(1)
                        elif comm_prob == 10:
                            comment_box.send_keys('So coollll and hottt! :)')
                            sleep(1)
