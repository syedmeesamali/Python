...
face_cascade = cv2.CascadeClassifier('C:/Users/SYED/Desktop/Python/15_Lock-Unlock-FaceCam/haarcascade_frontalface_default.xml') # Detect object in video stream using Haarcascade Frontal Face
