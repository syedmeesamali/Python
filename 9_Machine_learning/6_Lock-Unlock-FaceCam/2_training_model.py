...
detector = cv2.CascadeClassifier("C:/Users/SYED/Desktop/Python/15_Lock-Unlock-FaceCam/haarcascade_frontalface_default.xml")
...
faces,ids = getImagesAndLabels('C:/Users/SYED/Desktop/Python/15_Lock-Unlock-FaceCam/dataset')  # Get the faces and IDs

recognizer.train(faces, np.array(ids)) # Train the model using the faces and IDs

assure_path_exists('C:/Users/SYED/Desktop/Python/15_Lock-Unlock-FaceCam/trainer/')    # Save the model into trainer.yml
recognizer.save('C:/Users/SYED/Desktop/Python/15_Lock-Unlock-FaceCam/trainer.yml')
